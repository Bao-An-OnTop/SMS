...
\033[1;32m╚═════╝░╚═╝░░░░░╚═╝╚═════╝░\n
\033[1;33m╔══════════════════════════════════════════════════════╗
\033[1;33m║\033[1;31m🔥 ADMIN: {xanhla}BAO AN                                                             
\033[1;33m║\033[1;32m🔥 DEVELOP: {vang}MANH DANG KHOi                                                                                     
...
def hoangphuc(sdt):
    ...
    if response ['success'] == True:
        print(f'[BY: BAOAN] ~ \033[1;35m HOANG PHUC SPAM THÀNH CÔNG')
    else:
        print(f'[BY: BAOAN] ~ \033[1;35m HOANG PHUC SPAM THẤT BẠI')
...
def fmplus(sdt):
    ...
    if response ['Code'] == 200:
        print(f'[BY: BAOAN] ~ \033[1;35m FMPLUS SPAM THÀNH CÔNG')
    else:
        print(f'[BY: BAOAN] ~ \033[1;35m FMPLUS SPAM THẤT BẠI')
...
def winmart(sdt):
    ...
    try:
        if response ['code'] == 'S200':
            print(f'[BY: BAOAN] ~ \033[1;35m WINMART SPAM THÀNH CÔNG')
        else:
            print(f'[BY: BAOAN] ~ \033[1;35m WINMART SPAM THẤT BẠI')
    except:
        print(f'[BY: BAOAN] ~ \033[1;35m WINMART SPAM THẤT BẠI')
